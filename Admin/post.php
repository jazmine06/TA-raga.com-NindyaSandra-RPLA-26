                            ...
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-sm-6 mb-3">
                                        <h5>Berita Terkirim</h5>
                                        <span>
                                    Silahkan menggunakan tombol <strong>edit dan delete</strong> untuk melakukan tindakan.
                                    </span>
                                    </div>
                                ...
                                <table class="table table-hover dt-responsive" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="desktop text-center" width="10%">Kategori</th>
                                            <th class="desktop text-center" width="12%">Tanggal</th>
                                        </tr>
                                    </thead>
                                    <tbody class="body-table">
                                        <tr>
                                            ...
                                            <td class="text-center"><span class="text-muted">Diunggah <abbr title="2022-10-15 10:08:30">15 November 2022</abbr></span></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <label class="mz-check mb-0">
                                            ...
                                            <td>
                                                Jorge Martin Siap Bertarung dengan Fabio Quartaro di MotoGP Valencia 2022                                                <div class="row-action">
                                                    <span><a class="mz-link" href="#'">Edit</a></span>
                                                    <span><a class="mz-link delete" href="#">Delete</a></span>
                                            ...
                                            <td class="text-center"><span class="text-muted">Diunggah <abbr title="2022-11-13 10:08:30">13 November 2022</abbr></span></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <label class="mz-check mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                PUBG Berasal dari Negara Mana? Yuk Ketahui Jawabannya!                                              
                                                  <div class="row-action">
                                                    <span><a class="mz-link" href="#'">Edit</a></span>
                                                    <span><a class="mz-link delete" href="#">Delete</a></span>
                                            ...
                                            <td class="text-center"><span class="text-muted">Diunggah <abbr title="2022-11-12 10:08:30">12 November 2022</abbr></span></td>
                                        </tr>
