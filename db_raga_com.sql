...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=4147123444ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="664">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_raga.com&table=tbl_kategori">`db_raga.com`.`tbl_kategori`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_raga.com&table=tbl_login">`db_raga.com`.`tbl_login`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_raga.com&table=tbl_berita">`db_raga.com`.`tbl_berita`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=artikel&table=artikel">`artikel`.`artikel`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_raga.com&table=tbl_komentar">`db_raga.com`.`tbl_komentar`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_raga.com&table=user">`db_raga.com`.`user`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="727a3d5a2d645247704123442b7e3d46">
...
</span><small>Setel ke 0 untuk menutup panel navigasi.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="664"><a class="restore-default hide" href="#NavigationWidth" title="Kembalikan nilai bawaan"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
